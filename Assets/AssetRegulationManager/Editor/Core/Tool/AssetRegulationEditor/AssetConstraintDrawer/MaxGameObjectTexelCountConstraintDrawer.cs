...
{
    [CustomGUIDrawer(typeof(MaxGameObjectTexelCountConstraint))]
    internal sealed class MaxGameObjectTexelCountConstraintDrawer : GUIDrawer<MaxGameObjectTexelCountConstraint>
    {
        protected override void GUILayout(MaxGameObjectTexelCountConstraint target)
        {
