...
namespace AssetRegulationManager.Editor.Foundation
{
    internal sealed class TextFieldPopup : PopupWindowContent
    {
        ...
        private TextFieldPopup(string text, Action<string> changed, Action closed, string message = null,
            float width = 300)
        {
            _message = message;
            _text = text;
        ...
        public static void Show(Vector2 position, string text, Action<string> changed, Action closed,
