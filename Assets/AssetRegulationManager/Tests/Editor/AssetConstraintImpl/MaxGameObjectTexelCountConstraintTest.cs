...
{
    internal sealed class MaxGameObjectTexelCountConstraintTest
    {
        [Test]
        public static void Check_CountIsEqualsToConstraint_ReturnTrue()
        {
            var constraint = new MaxGameObjectTexelCountConstraint();
        ...
        [Test]
        public static void Check_ExcludeChildrenAndCountIsEqualsToConstraint_ReturnTrue()
        {
            var constraint = new MaxGameObjectTexelCountConstraint();
        ...
        [Test]
        public static void Check_ExcludeChildrenAndCountIsGreaterThanConstraint_ReturnFalse()
        {
            var constraint = new MaxGameObjectTexelCountConstraint();
            constraint.ExcludeChildren = true;
            constraint.ExcludeInactive = false;
